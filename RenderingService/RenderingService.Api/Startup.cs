...
using RenderingService.Business;
using RenderingService.Data;

namespace RenderingService.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Rendering Service API", Version = "v1" });
            ...
            services.AddRenderingServiceBusiness();
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                c.RoutePrefix = "";
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Rendering Service V1");
            });
        }
    }
}
